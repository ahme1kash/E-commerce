const products = [
  ...
  },
  {
    ...
    description:
      'HIDIZS AP80 PRO Hi-Fi Bluetooth MP3 Player, Portable Hi-Res Digital Music Player with LDAC/aptX/DSD/FM Radio,Lossless Music Player with Full Touch Screen',
    brand: 'FIIO',
    category: 'Electronics',
    price: 7500,
    countInStock: 0,
  ...
  },
  {
    ...
    description:
      'Meet Echo Dot - Our most popular smart speaker with a fabric design.Our most compact smart speaker that fits perfectly into small space',
    brand: 'Amazon',
    category: 'Electronics',
    price: 1500,
    countInStock: 3,
  ...
  },
  {
    ...
    description:
      'Smart Android television,32 inch screen with Super HD display',
    brand: 'Xiaomi',
    category: 'Electronics',
    price: 16000,
    countInStock: 4,
